...
def shelter():
    ...
    if "A cold cave" in choice or "cold cave" in choice:
        ...
        print "The next step will be picking some stuff you can eat for dinner."
        food()
...
def food():
    ...
    print "Which kind do you choose? "
    choice = raw_input("> ")
...
def time_travel():
    ...
    year = int(choice)
    if year < 1850:
        print "You don't have that much engery in your time travel machine to travel that far. Choose another year to collect the missing code to give your machine the extra boost."
        print "Hint: search for a name, change the letters to numbers (number in alphabet) and write a time < 1850 and the code you get to travel to sometime before 1850."
        time_travel()
    elif year < 1850 
